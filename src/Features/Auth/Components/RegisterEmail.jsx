...
const RegisterEmail = () => {
  ...
  return (
    <div className="flex flex-col justify-center w-full  h-screen ">
      <div
        className={`w-full max-w-md mx-auto h-screen overflow-hidden  flex flex-col md:${middleTheme()} p-5`}
      >
        ...
        <div className="mt-20 md:mt-32 flex flex-col">
          ...
          >
            ...
            <div className="mt-10 flex flex-col items-center sticky md:mt-32 left-0  ">
