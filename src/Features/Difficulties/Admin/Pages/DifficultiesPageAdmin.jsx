...
import CreateDifficultis from "../Modal/CreateDifficulties";
import UpdateDifficulties from "../Modal/UpdateDifficulties";
import { fetchDeleteDifficulties } from "../../Reducer/difficultiesSlice";
...
const DifficultiesPageAdmin = () => {
  ...
  // function update untuk membukan modal update
  ...
  //  function untk  membuka modal create
  const handleModalCreate = () => {
    setIsOpen(true);
  };

  //  funtion untuk menutup modal create
  ...
  if (status === "failed") {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen text-red-500">
        ...
        <button
          onClick={() => dispatch(fetchDifficulties())}
