...
const ModalSejarah = ({ isOpen, onClose }) => {
  if (!isOpen) {
    return null;
  }
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-5">
      ...
      >
        <div className="flex flex-col ">
          <h2 className="text-lg font-[600] mb-3 ">Sejarah Para Nabi</h2>
          <h1 className="text-md font-[500] mb-1">Sejarah Nabi Adam</h1>
