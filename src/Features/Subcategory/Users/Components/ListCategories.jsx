...
//   const { getButtonClassListCategory, getButtonClass, middleTheme, getIconColorAlert } =
//     useTheme();
...
//       <div
//         className={`py-2 flex flex-col text-xl  flex-grow max-w-md mx-auto w-full ${middleTheme()} `}
//       >
//         <div className="flex justify-between -mt-2 items-center mr-14 md:mr-1">
//           <div
//             onClick={() => navigate(-1)}
...
//           <IoSearch
//             className="text-2xl -mt-[43px] cursor-pointer mr-5"
...
//             <div className="flex mx-auto flex-col justify-center w-full mt-[100px] md:mt-[250px]">
...
//                 <button
//                   type="button"
//                   className={`p-3 w-[340px] mx-auto flex flex-col justify-center items-center -mt-2 rounded-xl ${
//                     selectCategory
