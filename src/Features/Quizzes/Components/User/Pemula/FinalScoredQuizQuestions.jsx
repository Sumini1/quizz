...
// import FinalScoredQuizQuestions from './FinalScoredQuizQuestions';

const FinalScoredQuizQuestions = () => {
  const { theme, getIconTheme, getBorderColor, getIconColorAlert, middleTheme } = useTheme();
  ...
  return (
    <>
      <div className="flex justify-center w-full h-full min-h-screen">
        <div className={`flex flex-col flex-grow max-w-md w-full ${middleTheme()}`}>
...
export default FinalScoredQuizQuestions;
