...
const Beranda = () => {
  ...
  return (
    <>
      <div className={`flex flex-col flex-grow h-[370px] ${getLatarBeranda()}`}>
          ...
          >
            <div className="flex gap-3">
              {category.map((item) => (
                ...
                >
                  <div className="flex bg-white rounded-full h-[50px] w-[50px] justify-center items-center p-2">
                    <h5>{item.image}</h5>
                  </div>
        ...
        <div className="px-4 py-3   mb-5 bg-[#F8FFF6] mt-5 w-full flex flex-col">
          ...
          <p className="text-sm font-normal">
            Partisipasi perkembangan sistem serta pembuatan soal & materi untuk
            mewujudkan pendidikan islam gratis bagi muslimin dan umum.
          </p>
        ...
        <div className="px-4 py-3 -mt-2  mb-5 w-full flex flex-col">
          ...
          <div className="overflow-x-auto whitespace-nowrap pb-4 flex gap-3 scrollbar-thin scrollbar-thumb-scrollbarThumb scrollbar-track-scrollbarTrack">
            {materiTerbaru.map((item) => (
              ...
              >
                {/* Ganti <h5> dengan tag <img> dan hilangkan border */}
