...
const IntroTestDua = () => {
  ...
  return (
    <div className="flex flex-col   h-screen overflow-hidden py-12 w-full max-w-lg mx-auto">
      ...
      <div className="flex flex-col p-5 ">
        ...
        <div className="grid grid-cols-3  gap-x-5 w-full max-w-sm   mx-auto justify-center items-center ">
          {items.map((item) => (
            <div
              key={item.id}
            ...
            >
              <div className="flex gap-2 justify-center items-center">
                ...
                <p className="text-xs font-medium text-center">{item.value}</p>
              </div>
              <h1
