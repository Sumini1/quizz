          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col mt-3">
              ...
              <p className="text-sm text-gray-500 mt-1">
                ...
                <span onClick={() => navigate("/test/sertifikat-kelulusan")} className="text-[#28A745] ml-1">lihat contoh penerapan</span>
              </p>
            </div>
            ...
            <div className="flex flex-col mt-3">
              ...
              <p className="text-sm text-gray-500 mt-1">
                ...
                <span className="text-[#28A745] ml-1">lihat contoh penerapan.</span>
              </p>
            </div>
