...
const Tutorial6 = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-5">
      ...
      <div className=" bg-white p-3 fixed top-14 w-[250px] rounded-lg shadow-md text-sm text-gray-800   ">
        {/* Konten Informasi */}
      ...
      <div className="flex justify-between bg-[#DCE6F8] p-3 rounded-lg shadow-md text-sm text-gray-800 w-[270px] -mt-56 items-center">
