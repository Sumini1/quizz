    ...
    <div className="flex flex-col p-5 h-screen md:justify-start md:items-start md:ml-10 md:py-10">
      ...
      <div>
        <div className="flex flex-col mt-24">
          <h1 className="text-lg">Apa arti dari ihsan ?</h1>
        </div>
        <div className="flex flex-col   gap-5 mt-10 ">
          {["Ihsan adalah iman kepada malaikat", "Ihsan adalah membaca Al-Qur'an", "Ihsan adalah belajar hadits", "Ihsan adalah menyembah Allah seakan-akan melihat-Nya"].map((answer, index) => (
            <p
              key={index}
