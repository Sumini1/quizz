      ...
      <div>
        ...
        <div className="flex flex-col   gap-5 mt-10 ">
          {[
            ...
            <h5
              key={index}
              className={`flex border ${getBorder()} p-2 w-full  px-5 cursor-pointer rounded-md ${
...
export default PageTujuhKeimanan;
