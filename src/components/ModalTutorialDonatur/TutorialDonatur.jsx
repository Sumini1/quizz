...
const TutorialDonatur = () => {
  ...
  const handleClick = () => {
    ...
    navigate("/papan-peringkat-nama-donatur"); // Pindah ke halaman 2
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex flex-col items-center h-screen p-5">
      <div className="w-[250px] mt-28">
        ...
        <div className="relative bg-white p-3 rounded-lg shadow-md text-sm text-gray-800">
          {/* Panah kecil di atas */}
          <div className="absolute -top-2 right-6 transform -translate-x-1/2">
            <svg
          ...
          <p className="border-b border-gray-400 pb-2 ">
            Papan peringkat laporan donasi soal dan materi dari para donatur
          </p>
          <div
            onClick={handleClick}
...
export default TutorialDonatur;
